...
export default function ResetPasswordPage() {
    ...
    async function onSubmit(_values: FormValues) {
        ...
        try {
            ...
            // TODO: await fetch(`${import.meta.env.VITE_API_URL}/auth/reset-password`, { method:'POST', body: JSON.stringify({ token, password: _values.password }) })
            setDone(true)
        } catch {
            setServerError('The link may have expired. Please request a new one.')
        } finally {
            setIsLoading(false)
        }
    }
            ...
            <div className="w-full max-w-sm animate-fade-in">
                ...
                {done ? (
                    ...
                    <div className="space-y-4">
                        ...
                        <Link
                            to="/login"
                            className="inline-flex items-center gap-1.5 text-sm text-foreground font-medium hover:text-primary transition-colors"
                        >
